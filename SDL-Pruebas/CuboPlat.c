...
int main()
{
	...
	SDL_Rect plataforma = {195, 245, 245, 100};	
	...
	{	
		...
		if(!SDL_HasIntersection(&cubonuevo, &plataforma))
		{
			cuadrado=cubonuevo;
	        }

		SDL_RenderCopy(renderer, fondoTexture, NULL, NULL);   //Nuestro fondo
		//SDL_SetRenderDrawColor(renderer, 0, 255, 0, 255);	      //Se dibuja la plataforma
		//SDL_RenderFillRect(renderer, &plataforma);					      
